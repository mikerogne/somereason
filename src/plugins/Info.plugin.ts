...
class InfoPlugin {
    ...
    load(client: IrcClient, configService: Config, _env: EnvJson) {
        ...
        client.addListener('message', (from: string, to: string, text: string, message: Message) => {
            ...
            const infoMessage = `Hi! 💚 I'm a learning experiment gone wrong! Here are some things to try: .docs <phrase>, .tenor <phrase>, .yt <phrase>, .8ball <question> and more: https://github.com/mikerogne/somereason`;
